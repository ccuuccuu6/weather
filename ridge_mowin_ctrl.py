...
residuals = []
coefficient_history = []
# Initialize list to store feature contributions (for dummy variables only)
...
for i in range(window_size, len(df)):
    ...
    # Calculate feature contributions: each dummy's value times its coefficient
    contributions = (X_current.values.flatten() * model.coef_)
...
# Define the feature names as "Intercept" plus dummy variable names
