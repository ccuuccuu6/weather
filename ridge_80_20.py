...
# -----------------------------------------------------------------
# 7. Fit the Polynomial Ridge Regression Model
# -----------------------------------------------------------------
model = Ridge(alpha=1.0)  # Using Ridge regression; adjust alpha as needed.
...
plt.title('Polynomial Ridge Regression (No Dummy Expansion): Predicted vs. Actual')
plt.legend()
plt.show()
...
plt.title('Polynomial Ridge Regression Coefficients (No Dummy Expansion)')
plt.legend()
plt.show()
